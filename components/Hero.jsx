...
const Hero = () => {
  return (
    <div className="flex justify-center text-right mt-[15%] md:mt-[10%] lg:mt-[8%]">
      <Image
        ...
        className="z[0]"
      />
      <div className="flex flex-col items-center bg-black/30 text-white text-center z-[100] p-8">
