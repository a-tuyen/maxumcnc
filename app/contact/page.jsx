  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-full">
        <h1 className="flex justify-center pt-16 bg-accent1 w-full text-white">
          Contact Us
        </h1>
        <div className="bg-accent1 grid grid-cols-4 w-full py-12">
          <div className="flex flex-col items-center text-white text-center">
            <div className="bg-accent2 rounded-full p-10">
              <Image
